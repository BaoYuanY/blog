...
class CoordinateService
{
     ...
     * @return float[]
     */
    public static function bd09ToGcj02($bd_lon, $bd_lat): array
    {
        $x     = $bd_lon - 0.0065;
        $y     = $bd_lat - 0.006;
     ...
     * @return float[]
     */
    public static function gcj02Tobd09($g_lon, $g_lat): array
    {
     ...
     * @return float[]
     */
    public static function wgs84ToGcj02($w_lon, $w_lat): array
    {
     ...
     * @return float[]
     */
    public static function gcj02ToWgs84($g_lon, $g_lat): array
    {
     ...
     * @return float[]
     */
    public static function bd09ToWgs84($bd_lon, $bd_lat): array
    {
     ...
     * @return float[]
     */
    public static function wgs84ToBd09($w_lon, $w_lat): array
    {
     ...
     * @return float
     */
    protected static function transFormLat($lon, $lat): float
    {
     ...
     * @return float
     */
    protected static function transFormLon($lon, $lat): float
    {
